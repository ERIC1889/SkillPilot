...
function Dashboard() {
  ...
  const userInfo = { name: '김지민', id: 'kim_jimin_99', email: 'jimin.kim@example.com', joinedDate: '2025.01.10' };
  
  const myActivityStats = [
    { label: '총 학습 시간', value: '128시간', sub: '지난주 대비 +12%', icon: <ClockIcon /> },
    { label: '취득 자격증', value: '2개', sub: '정보처리기사 준비중', icon: <DiplomaIcon /> },
    { label: '나의 랭킹', value: '상위 5%', sub: '전체 12,403명 중', icon: <TrophyIcon /> },
  ];
