      ...
      <form className="signup-form" onSubmit={handleSubmit}>
        ...
        {form.job === "대학생" && (
          <div className="input-group">
            ...
            <input name="major" placeholder="전공을 입력하세요" value={form.major} onChange={handleChange} />
          </div>
        )}
        ...
        <div className="input-group">
          ...
          <input name="interest" placeholder="예: 백엔드 개발" value={form.interest} onChange={handleChange} />
        </div>
